      ...
      <div className="w-full max-w-md bg-white dark:bg-[#1C1C1F] rounded-t-3xl sm:rounded-3xl p-5 shadow-2xl border border-gray-100 dark:border-white/10 max-h-[85vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-[#8B1121]/10 dark:bg-[#8B1121]/20 flex items-center justify-center text-[#8B1121] dark:text-[#ff4d6d]">
            ...
            <div>
              ...
              {userHandle ? (
                ...
                <p className="text-[11px] text-[#8B1121] dark:text-[#ff4d6d] font-medium">Burger Kafe a'zosi</p>
              )}
            </div>
          </div>
          <button
